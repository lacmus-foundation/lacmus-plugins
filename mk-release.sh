...
dotnet publish --framework net5.0 --runtime="linux-x64" -c Release -o ./build/app/linux_amd64 App/App.csproj
echo -n "building for win\n"
dotnet publish --framework net5.0 --runtime="win-x64" -c Release -o ./build/app/win_amd64 App/App.csproj
echo -n "building for osx\n"
dotnet publish --framework net5.0 --runtime="osx-x64" -c Release -o ./build/app/osx_amd64 App/App.csproj
echo -n "building lacmus plugin [cpu]\n"
dotnet publish --framework net5.0 -c Release -o ./build/plugins/LacmusRetinanetPlugin.Cpu LacmusRetinanetPlugin/LacmusRetinanetPlugin.csproj
